...
2. Use the file navigator to find the `R-functional-programming` folder that you downloaded. 
...
If you do not have R installed and the materials loaded for your workshop by the time it starts, we *strongly* recommend using the UC Berkeley DataHub to run the materials. You can access the DataHub by clicking [this link](https://datahub.berkeley.edu/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fdlab-berkeley%2FR-functional-programming&urlpath=rstudio%2F&branch=main)
